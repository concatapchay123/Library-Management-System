...
/**
 * Accessible Labeled Input Component for OpenLibraryOS.
 *
 * Adheres strictly to design invariants:
 * - Single-column vertical stacking (Label above Input)
...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(function Input(
  ...
  const inputStyle: React.CSSProperties = {
    ...
    border: `1px solid ${isInvalid ? tokens.colors.status.danger.color : isFocused ? tokens.colors.borderFocus : tokens.colors.border}`,
